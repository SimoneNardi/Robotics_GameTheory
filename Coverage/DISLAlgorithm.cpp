...
//////////////////////////////////////////////////////////////////////////
std::string DISLAlgorithm::getExplorationRateStr()
{
...
//////////////////////////////////////////////////////////////////////////
double DISLAlgorithm::getExplorationRate()
{
...
//////////////////////////////////////////////////////////////////////////
void DISLAlgorithm::communicate(std::shared_ptr<Guard> _agent)
{
...
//////////////////////////////////////////////////////////////////////////
void DISLAlgorithm::compute(std::shared_ptr<Guard> _agent)
{
...
//////////////////////////////////////////////////////////////////////////
void DISLAlgorithm::updateCounterOfVisibleSquare( std::shared_ptr<Guard> _agent )
{
...
//////////////////////////////////////////////////////////////////////////
void DISLAlgorithm::updateCounterOfVisibleSquare()
{
...
///
bool DISLAlgorithm::forwardOneStep()
{
...
//////////////////////////////////////////////////////////////////////////
bool DISLAlgorithm::forwardOneStep(std::shared_ptr<Guard> _agent)
{
	double l_rate = this->computeExplorationRate();
	if(l_rate < 1.e-5)
		return false;
...
//////////////////////////////////////////////////////////////////////////
void DISLAlgorithm::computeNextPosition()
{
	for(std::set<GuardPtr>::iterator it = m_guards.begin(); it != m_guards.end(); ++it)
...
//////////////////////////////////////////////////////////////////////////
void DISLAlgorithm::resetCounter()
{
	m_space->resetCounter();
}

//////////////////////////////////////////////////////////////////////////
void DISLAlgorithm::resetValue()
{
	m_space->resetValue();
}

//////////////////////////////////////////////////////////////////////////
void DISLAlgorithm::monitoringThieves(std::set< ThiefPtr > const& _agents)
{
...
/////////////////////////////////////////////////////////////////////////
void DISLAlgorithm::getGuardsPosition(std::vector<AgentPosition> & _pos)
{
	_pos.clear();
...
//////////////////////////////////////////////////////////////////////////
void DISLAlgorithm::getGuardsCoverage( std::vector< std::vector<IDS::BaseGeometry::Point2D> > & _areas)
{
	for(set<GuardPtr>::iterator it = m_guards.begin(); it != m_guards.end(); ++it)
	{
...
//////////////////////////////////////////////////////////////////////////
int DISLAlgorithm::getGlobalTrajectoryCoverage()
{
...
//////////////////////////////////////////////////////////////////////////
double DISLAlgorithm::getBenefitValue()
{
	double l_total = 0.;
	for(std::set<GuardPtr>::iterator it = m_guards.begin(); it != m_guards.end(); ++it)
	{
...
double DISLAlgorithm::getPotentialValue()
{
	double l_total = 0.;
